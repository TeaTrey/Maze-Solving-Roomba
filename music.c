...
void load_songs() {
	...
	oi_loadSong(12, rickrollNumNotes, rickrollNotes, rickrollDuration);
	...
	oi_loadSong(15, ImperialMarchNumNotes, ImperialMarchNotes, ImperialMarchDurations);
	...
	oi_loadSong(14, mario1NumNotes, mario1Notes, mario1Duration);
	...
	oi_loadSong(13, mario2NumNotes, mario2Notes, mario2Duration);
	oi_free(sensor_data);
}
